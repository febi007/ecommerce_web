...
<script>
    ...
    function add() {
        $("#modal_title").text("Tambah Shipping Service");
        $("#param").val("add");
    ...
    function edit(id) {
        $.ajax({
            ...
            success: function (res) {
                if (res.status) {
                    $("#modal_title").text("Edit Shipping Service");
                    $("#param").val("edit");
                    $("#id").val(id);
                    $("#title").val(res.res_data['title']);
                    $("#status").val(res.res_data['status']);
                    $('#result_image').attr('src', res.res_data['image']);
                    $("#modal_home_slide").modal("show");
                    setTimeout(function () {
                        $("#title").focus();
                    }, 600);
    ...
    function ValidateFileUpload() {
        ...
        if (FileUploadPath == '') {
            ...
            if (Extension == "svg" || Extension == "gif" || Extension == "png" || Extension == "bmp" || Extension == "jpeg" || Extension == "jpg") {
