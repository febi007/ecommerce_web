                ...
                <div class="modal-body">
                    <div class="box-body">
                        <div class="form-group">
                            <?php $label = 'video_share'; ?>
                            <label for="<?=$label?>" class="col-sm-2 control-label">Id Video Youtube</label>

                            <div class="col-sm-10">
                                <input type="text" name="<?=$label?>" class="form-control" id="<?=$label?>" autocomplete="off" placeholder="Id Video Youtube">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status) {
                    ...
                    $("#param").val("edit");
                    $("#id").val(id);
                    $("#video_share").val(res.res_data['video_share']);
