                ...
                <div class="modal-body">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="<?=$label?>" class="form-control" id="<?=$label?>" autocomplete="off" placeholder="Nama Merk">
                            </div>
                        </div>
                        <div class="form-group">
                            <?php $label = 'gambar'; ?>
    ...
    function edit(id) {
        $.ajax({
            ...
            success: function (res) {
                if (res.status) {
                    $("#modal_title").text("Edit Merk");
                    $("#param").val("edit");
                    $("#id").val(id);
                    $("#nama").val(res.res_merk['nama']);
                    $("#preview").attr("src", "<?=base_url()?>"+res.res_merk['gambar']);
                    document.getElementById("img_preview").style.display = 'block';
                    if (res.res_merk['status']=='0') {
